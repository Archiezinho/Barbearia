          ...
          <div id="customers-testimonials" class="owl-carousel">
            <div class="item">
              <div class="shadow-effect">
                <img class="img-circle" src="images/barbearialogo.png" alt="">
                <p>Tempo de experiencia: 2 anos idade: 22 anos <br> especialidade: Degradê </p>
              </div>
              <div class="testimonial-name">Pedro</div>
            </div>
            <div class="item">
              <div class="shadow-effect">
                <img class="img-circle" src="images/barbearialogo.png" alt="">
              ...
              <div class="testimonial-name">Jefferson</div>
            </div>
          </div>
        </div>
      </div>
  ...
  <footer class="footer text-center">
    <div class="container">
      <ul class="list-inline">
        ...
        <li class="list-inline-item">
          <a class="social-link rounded-circle text-white" href="https://www.instagram.com/barbearia">
