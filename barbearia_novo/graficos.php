                        ...
                        <div class="table-responsive">
                            <table>
                                ...
                                <tbody>
                                    <tr>
                                        <?php
                                        $result = $conn->query("select nomeCliente,barbeiro,valorCorte,nome from cortes as C INNER JOIN barbeiro as B on C.barbeiro= B.id_barbeiro  where valorCorte > 0");
