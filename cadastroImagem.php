...
<div class="sidebar">
    ...
    <section id="Banner1" class="content-section">
        ...
        <div class="auth login">
            <p class="title">Cadastrar Imagem</p>
            <form method="POST" action="php/upload.php" id="register" enctype="multipart/form-data">
                <input type="file" name="imagem" class="field" required="required"/>
                <input type="submit" class="submit" value="enviar">Cadastrar</input>
            </form>
        </div>
